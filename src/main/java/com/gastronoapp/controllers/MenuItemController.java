...
public class MenuItemController {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<MenuItem> updateMenuItem(@PathVariable int id, @RequestBody MenuItem updates) {
        return ResponseEntity.ok(menuItemService.updateMenuItem(id, updates));
    }
